...
export type WebSocketMessage = {
    type: 'log_entry' | 'stats_update' | 'dialogue_message' | 'timer_sync' | 'topology_update' | 'evolution_update' | 'sovereignty_update' | 'synthesis_update' | 'terminal_log' | 'soul_update' | 'comment_engagement';
    timestamp: string;
    payload: any;
};
