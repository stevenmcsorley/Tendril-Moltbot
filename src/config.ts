...
const configSchema = z.object({
    ...
    BSKY_THREAD_DEPTH: z.coerce.number().int().min(1).max(10).default(3),
    ...
    MAX_COMMENTS_PER_DAY: z.coerce.number().positive().default(2000),
    POST_COOLDOWN_MINUTES: z.coerce.number().positive().default(5),
    COMMENT_COOLDOWN_SECONDS: z.coerce.number().positive().default(5),
    ...
    ADAPTIVE_POST_MINUTES_MIN: z.coerce.number().positive().default(2),
    ADAPTIVE_POST_MINUTES_MAX: z.coerce.number().positive().default(30),
    ADAPTIVE_COMMENT_SECONDS_MIN: z.coerce.number().positive().default(2),
    ADAPTIVE_COMMENT_SECONDS_MAX: z.coerce.number().positive().default(30),
    ADAPTIVE_FACTOR_HIGH: z.coerce.number().positive().default(0.6),
    ADAPTIVE_FACTOR_LOW: z.coerce.number().positive().default(0.85),
    ADAPTIVE_SILENCE_FACTOR: z.coerce.number().positive().default(1.25),
    ...
    REPLY_UPVOTE_MIN_CONFIDENCE: z.enum(['low', 'medium', 'high']).default('high'),
